...
var Player = {
	...
	init: function init(domId, playerId) {
		var _this = this;

		window.onYouTubeIframeAPIReady = function () {
			return _this.onIframeReady(domId, playerId);
		};
	...
	onIframeReady: function onIframeReady(domId, playerId) {
		var _this2 = this;
	...
	onPlayerReady: function onPlayerReady(event) {/* this.player.playVideo()*/},
...
var Video = {
  ...
  init: function init(socket, element) {
    ...
    _player2["default"].init(element.id, playerId);

    socket.connect();
    var vidChannel = socket.channel("videos:" + videoId);

    postButton.addEventListener("click", function (e) {
      console.log(_player2["default"].getCurrentTime());
